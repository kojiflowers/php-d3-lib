...
class D3_Bar_Graph
{
    ...
    function buildSimpleBarChart()
    {
       ...
       $return .= "var x = d3.scale.ordinal().rangeRoundBands([0, width], .1);";
       $return .= "var y = d3.scale.linear().range([height, 0]);";
       $return .= "var xAxis = d3.svg.axis().scale(x).orient(\"bottom\");";
       $return .= "var yAxis = d3.svg.axis().scale(y).orient(\"left\").ticks($this->ticks, \"%\");";
