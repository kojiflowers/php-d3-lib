...
/**
 * Class AdvancedSunburstChart
 * @package PhpD3\Builder
 */
class AdvancedSunburstChart extends Builder
{
    ...
    function __construct($full_data_array=array())
    {
        ...
        $this->generateColors($full_data_array,'json');
    ...
    function buildChart(){
        ...
        $chart ="var radius = Math.min(width, height) / 2;
